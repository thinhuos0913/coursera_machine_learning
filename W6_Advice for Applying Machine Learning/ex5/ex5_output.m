...
%  In our cross validation, we obtained a test error of 3.8599 for ? = 3.
best_lambda = 3;
...
%  
%  Plot the learning curve obtained for polynomial regression with ? = 0.01
...
for i = 1:m
  ...
  error_val_sum = 0;
  for k = 1:k_MAX
    rand_seq = round( rand(1,i)*(m-1) )+1;  % ??i?[0,m]?????
